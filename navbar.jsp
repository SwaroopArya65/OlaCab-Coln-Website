 <div class="container-fluid p-0 m-0" style="position: fixed;z-index: 100 ">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" role="search">
                        <div class=" nav-btn" style="display: <%=display %>">
                            <a class="btn text-white me-1" id="login-btn" href="loginPage.jsp"> <span><i class="bi bi-person-fill"></i></span> Log in</a>
                        </div>

                        <div class=" nav-btn" style="display: <%=display %>">
                            <a class="btn text-white me-2" id="signup-btn" href="signUp.jsp">Sign up</a>
                        </div>
                        <div class=" nav-btn">
                            <a class="btn " type="submit" id="booknow-btn" href="booknow.jsp" >Book Now</a>
                        </div>
